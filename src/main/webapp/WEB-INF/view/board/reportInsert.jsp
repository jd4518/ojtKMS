...
<body>
<div align="center">
      <form name="reportWrite" method="post" enctype="multipart/form-data" action="reportWrite.do"> <!-- 업로드 설정  enctype="multipart/form-data"-->
      <table class="table">
      <thead class="htable">
      <tr>
      	<th colspan="2" style="font-size:50px; font-style: italic; ">신고하기</th>
      </tr>
         <tr>
            <th style="font-size: x-large; text-align: center;">제목</th>
            <th><input type="text" name="stopTitle" class="form-control" style="border: 0px;" data-ng-model-options="{ updateOn: 'blur' }" >
            	<input type="hidden" name="sMemberId" value="${member.memberId }">
      ...
      <tbody class="btable">
         <tr >
            <td colspan="2"><textarea class="form-control" name="stopReason" data-ng-model-options="{ updateOn: 'blur' }"  rows="20" cols="130" style="background-color: #aaa; border: 0px; color:black;"></textarea>
            </td>
         </tr>
         <tr>
	         <td colspan="2">
